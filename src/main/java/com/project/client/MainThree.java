...
public class MainThree {
    ...
    public MainThree(String serverUri) {
        ...
        try {
            ...
            switch (t) {
                ...
                default -> {
                    ...
                    System.out.println("Message content: " + o.toString(2));
                    // ignore
                }
            }
    ...
    public static void main(String[] args) {
        String serverURI = (args.length > 0) ? args[0] : "wss://matrixplay3.ieti.site:443";
        System.out.println("[client] Connecting to server: " + serverURI);
        MainThree app = new MainThree(serverURI);
        app.run();
    }
}
